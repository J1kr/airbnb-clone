...
def github_login(request):
    ...
    redirect_uri = "http://mogki.com:8080/users/login/github/callback"
    return redirect(
        ...
        if code is not None:
            ...
            if error is not None:
                ...
                if username is not None:
                    ...
                    raise GithubException(f"Welcome back {user.first_name}")
        else:
...
def kakao_login(request):
    ...
    redirect_uri = "http://mogki.com:8080/users/login/kakao/callback"
